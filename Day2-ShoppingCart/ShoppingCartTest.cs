...
namespace Day2_ShoppingCart
{
    ...
    public class ShoppingCartTest
    {
        ...
        [TestMethod]
        public void PromotionTest_GivenBuyVol_1To3_EachFor_1_ThenBuyVol_5_For_2_ThenHitCheckout_TotalAmountShouldBe()
        {
            //arrange
            Book poterVol1 = new Book() { Name = "哈利波特第一集", Price = 100 };
            Book poterVol2 = new Book() { Name = "哈利波特第二集", Price = 100 };
            ...
            double expectedAmount =
                (
                    (poterVol1.Price + poterVol2.Price + poterVol3.Price + poterVol5.Price) * 0.80
                )
                +
                (
                    (anotherPoterVol5.Price)
                )
                ;
